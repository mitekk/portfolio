        ...
        <ContentPanel>
          <div className="flex flex-col gap-5 max-w-150 justify-self-center">
            ...
            <article className="flex flex-col gap-4">
              ...
              <p className="font-light">
                Ran technical design and delivery for the company's core
                product. Established architectural standards, managed the CI/CD
                pipeline, and ensured high availability and performance for
                high-traffic, business-critical features.
              </p>
            </article>
            ...
            <article className="flex flex-col gap-4">
              ...
              <p className="font-light">
                Provisioned and maintained production cloud environments on
                Azure. Handled deployment pipelines, server configurations, and
            ...
            <article className="flex flex-col gap-4">
              ...
              <p className="font-light">
                Contributed to a highly structured enterprise codebase. Focused
                on writing testable code, conducting rigorous reviews, and
            ...
            <article className="flex flex-col gap-4">
              ...
              <p className="font-light">
                Developed foundational server-side and client-side logic for
                core applications. Handled database design, API creation, and
